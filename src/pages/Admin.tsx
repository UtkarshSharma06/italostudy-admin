...
const CheckoutAbandonmentsManager = lazy(() => import('@/components/admin/CheckoutAbandonmentsManager'));
const MockSessionManager = lazy(() => import('@/components/admin/MockSessionManager'));
                    ...
                    <div className="flex-1 overflow-y-auto scroll-smooth pt-6 lg:pt-10 pb-24 lg:pb-32 px-4 lg:px-6 xl:px-10">
                        <div className="w-full mx-auto">
                            <Tabs value={activeTab} className="space-y-0 no-tabs-list">
                                ...
                                <TabsContent value="notes" className="mt-0 focus-visible:outline-none">{activeTab === 'notes' && <NotesManager />}</TabsContent>
